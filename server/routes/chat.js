...
const { AccessChat, FetchChats, CreateGroupChat, RenameGroup, AddtoGroup, RemoveFromGroup, AddMultipleGroupAdmin, RemoveFromGroupAdmin, ChangeGroupImage } = require('../controller/chat');
...
router.put('/groupImg', verifyToken, ChangeGroupImage)
